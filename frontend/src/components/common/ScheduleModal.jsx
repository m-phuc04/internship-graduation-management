  ...
  return (
    ...
    >
      <div className="space-y-4 text-xs">
        ...
        {canManage && isFormOpen && (
          <form onSubmit={handleSave} className="p-4 bg-white rounded-2xl border border-blue-200 shadow-sm space-y-3 animate-in fade-in-50">
          ...
          {loading ? (
            ...
            schedules.map((item) => {
              ...
              return (
                <div
                  key={item._id}
                  className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-2xs hover:border-blue-200 transition space-y-2 group"
                >
