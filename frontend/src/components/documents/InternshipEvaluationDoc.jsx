    ...
    >
      ...
      <div className="space-y-2 mb-4">
        ...
        <table className="w-full border-collapse border border-black text-xs">
          ...
          <tbody>
            <tr>
              <td className="border border-black p-1.5 text-center font-bold text-[#123891]">PEO 1</td>
            ...
            <tr>
              <td className="border border-black p-1.5 text-center font-bold text-[#123891]">PEO 2</td>
              <td className="border border-black p-1.5 leading-snug">
            ...
            <tr>
              <td className="border border-black p-1.5 text-center font-bold text-[#123891]">PEO 3</td>
              <td className="border border-black p-1.5 leading-snug">
