              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center gap-3 pt-1">
                    ...
                    <label
                      className={`inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border text-xs font-semibold select-none transition cursor-pointer ${row.isCouncilReviewer
                    ...
                    >
                      ...
                      />
                      <span
                        className={`w-3.5 h-3.5 rounded border flex items-center justify-center transition ${row.isCouncilReviewer ? 'bg-white border-white text-amber-600' : 'border-slate-400'
                          }`}
                      >
