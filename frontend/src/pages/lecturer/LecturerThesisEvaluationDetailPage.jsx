      ...
      <div className="p-6 rounded-3xl bg-white border border-slate-200/80 shadow-2xs space-y-4">
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          <div className="flex items-start gap-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-[#0d2a75] to-[#123891] text-white flex items-center justify-center font-bold text-xl shadow-md shadow-blue-200 shrink-0 mt-1">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="p-4 bg-white rounded-2xl border border-blue-100 shadow-2xs space-y-1">
              <div className="text-[11px] font-bold text-[#123891] uppercase tracking-wider">Tổng số báo cáo nộp</div>
              <div className="text-2xl font-extrabold text-[#123891] font-mono">
            ...
            <div className="p-4 bg-white rounded-2xl border border-blue-100 shadow-2xs space-y-1">
              <div className="text-[11px] font-bold text-[#123891] uppercase tracking-wider">Tiến độ trung bình</div>
              <div className="text-2xl font-extrabold text-[#123891] font-mono">
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-mono font-bold text-[#123891] bg-blue-50 px-2.5 py-1 rounded-lg border border-blue-100">
          ...
          <div className="p-4 bg-white rounded-2xl border border-slate-200 flex items-center justify-between">
            ...
            <button
              type="button"
              onClick={() => setActiveTabSection('CRITERIA')}
              className="px-5 py-2.5 bg-[#123891] hover:bg-[#102d7d] text-white font-bold rounded-xl transition cursor-pointer text-xs flex items-center gap-1.5 shadow-xs"
            >
            ...
            <div className="space-y-3">
              ...
              <div className={`grid ${isTwoStudents ? 'grid-cols-1 sm:grid-cols-2' : 'grid-cols-1'} gap-4`}>
                ...
                <div className="p-4 rounded-2xl bg-white border-2 border-slate-200 hover:border-blue-300 transition space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-[#123891] text-xs flex items-center gap-2">
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full p-4 border rounded-2xl text-xs transition resize-none ${isFormLocked
                    ...
                    : 'bg-slate-50 border-slate-200 text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#123891]/20 focus:border-[#123891]'
                  }`}
              />
            </div>
              ...
              <div className="p-5 rounded-3xl bg-white border border-blue-100 space-y-2.5 text-xs shadow-2xs">
                <div className="font-bold text-[#123891] flex items-center justify-between border-b border-indigo-50 pb-2">
                  ...
                  <UserNameClickable
                    ...
                    name="Xem hồ sơ ↗"
                    showAvatar={false}
                    className="text-xs font-bold text-[#123891] hover:underline"
                  />
                </div>
