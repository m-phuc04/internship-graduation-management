      ...
      <div className="min-h-screen bg-slate-50 py-12 px-4 flex items-center justify-center">
        <div className="max-w-xl w-full p-8 sm:p-10 rounded-3xl bg-white border border-slate-200 shadow-xl text-center space-y-5 animate-in zoom-in-95">
          ...
          <div className="p-6 rounded-3xl bg-gradient-to-br from-indigo-50/90 via-white to-emerald-50/70 border border-blue-100/90 shadow-2xs space-y-2.5">
            ...
            <div className="text-xs font-semibold text-[#102d7d] bg-blue-100/70 py-1 px-3.5 rounded-full inline-block">
          ...
          <div className="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 text-left text-xs space-y-2 text-slate-700">
            ...
            <div className="flex justify-between items-center py-1 border-b border-slate-200/60">
              ...
              <strong className="text-[#102d7d] font-mono text-sm font-bold">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 print:space-y-4">
          ...
          <div className="p-6 sm:p-7 rounded-3xl bg-white border border-slate-200/90 shadow-2xs space-y-4 print:border print:border-black print:rounded-none print:p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              ...
              <div className="p-3 rounded-2xl bg-blue-50/60 border border-blue-100 print:bg-transparent print:border-none print:p-0 col-span-1 md:col-span-2">
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                <div className="font-bold text-slate-900">
                  <span className="text-[#102d7d] font-extrabold mr-1.5">PEO 1.</span>
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                <div className="font-bold text-slate-900">
                  <span className="text-[#102d7d] font-extrabold mr-1.5">PEO 2.</span>
              ...
              <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-2">
                <div className="font-bold text-slate-900">
                  <span className="text-[#102d7d] font-extrabold mr-1.5">PEO 3.</span>
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  {formData.score !== '' && !isNaN(formData.score) && (
                    <span className="text-xs font-semibold text-[#102d7d] bg-blue-50 px-3 py-1.5 rounded-xl border border-blue-100">
