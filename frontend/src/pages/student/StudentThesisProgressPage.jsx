        ...
        {thesis && (
          <div className="mt-6 pt-5 border-t border-slate-100 space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
              {/* Thesis Title */}
              <div className="p-3.5 rounded-2xl bg-indigo-50/60 border border-indigo-100/80 md:col-span-2">
                <div className="text-[10.5px] font-bold text-indigo-700 uppercase tracking-wider mb-1">
                  Đề tài Khóa luận
                </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200/80">
                ...
                <div className="text-[10.5px] text-indigo-600 font-semibold mt-0.5">
              ...
              <div className="p-3 rounded-2xl bg-indigo-50/80 border border-indigo-200/80">
                <div className="text-[11px] text-indigo-700 font-medium">Tiến độ tổng thể</div>
                <div className="text-lg font-bold text-indigo-700 font-mono mt-0.5">
                  {overallPercentage}%
                </div>
                <div className="text-[10.5px] text-indigo-600 font-medium mt-0.5">
                  ...
                  <div className="py-2.5 space-y-2.5">
                    {hasProgress ? (
                      <>
                        ...
                        {/* File Attachment */}
                        {hasFile && (
                          <div className="flex flex-wrap items-center justify-between gap-2 text-xs text-indigo-700 bg-indigo-50/60 px-3.5 py-2 rounded-2xl border border-indigo-100">
                      ...
                      {!hasProgress && (
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold rounded-xl border border-indigo-200 transition"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-xs transition"
                          >
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-2">
              ...
              {progressToConfirm.file && (progressToConfirm.file.fileUrl || progressToConfirm.file.fileName) && (
                <div className="flex items-center justify-between bg-white p-2.5 rounded-xl border border-indigo-100 mt-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-1 text-xs text-indigo-600 hover:text-indigo-800 font-bold shrink-0 ml-2"
                  >
                    <ExternalLink className="w-3.5 h-3.5" />
                    <span>Xem file</span>
                  </a>
          ...
          <div className="space-y-6 text-slate-900 font-serif p-4" id="printable-thesis-diary">
            ...
            <div className="flex items-center justify-between pt-4 border-t border-slate-200 font-sans">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-md transition text-xs"
              >
                <Printer className="w-4 h-4" />
