      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5 p-6 rounded-3xl bg-white border border-slate-200/80 shadow-2xs">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#153898] hover:bg-[#102d7d] active:scale-[0.99] text-white text-sm font-semibold rounded-xl shadow-sm shadow-blue-200 transition"
          >
                  ...
                  >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <div className="text-xs text-slate-500 flex items-center gap-2 mt-0.5">
                            {comp.code && (
                              <span className="font-mono font-bold text-[#153898] bg-blue-50 px-1.5 py-0.2 rounded text-[11px]">
                                {comp.code}
                              </span>
                            )}
                            {comp.website && (
                              <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="text-slate-400 hover:text-[#153898] truncate max-w-[120px]"
                              >
                    ...
                    <td className="py-3.5 px-4">
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-slate-100 text-slate-700">
                        <Users className="w-3 h-3 text-[#153898]" />
