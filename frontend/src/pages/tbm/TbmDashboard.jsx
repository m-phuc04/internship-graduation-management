      ...
      <div className="p-6 rounded-3xl bg-white border border-slate-200/80 shadow-2xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-xl font-bold text-slate-900 mt-0.5">
            Tổng Quan Thực Tập & Khóa Luận (Trưởng Bộ Môn)
          </h1>
          <p className="text-xs text-slate-500 mt-1">
            Theo dõi tiến độ thực tập doanh nghiệp, khóa luận tốt nghiệp, xét duyệt và đánh giá trong học kỳ.
          </p>
        </div>

        <button
          onClick={fetchDashboard}
          className="self-start md:self-auto inline-flex items-center gap-1.5 px-4 py-2 bg-slate-50 hover:bg-slate-100 text-slate-700 text-xs font-semibold rounded-xl border border-slate-200 transition cursor-pointer"
        >
